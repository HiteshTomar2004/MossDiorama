...
import { RunicMonolith } from './RunicMonolith'

export const DistrictProjects = ({ position = [-65, 0, -70] }) => {
  ...
  return (
    ...
    >
      {/* 3D Storybook Ancient Runic Monolith Landmark */}
      <RunicMonolith position={[0, 0, 0]} onInspect={handleClick} hovered={hovered} />

      {/* Floating Silksong HTML Badge */}
      <Html position={[0, 10.4, 0]} center distanceFactor={28}>
        <div
