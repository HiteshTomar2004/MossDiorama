...
import { TravelerCabin } from './TravelerCabin'

export const DistrictContact = ({ position = [88, 0, 85] }) => {
  ...
  return (
    ...
    >
      {/* 2.5D / 3D Hybrid Storybook Traveler's Cabin */}
      <TravelerCabin position={[0, 0, 0]} onInspect={handleClick} hovered={hovered} />

      {/* Floating Silksong HTML Badge */}
      <Html position={[0, 11.6, 0]} center distanceFactor={28}>
        <div
